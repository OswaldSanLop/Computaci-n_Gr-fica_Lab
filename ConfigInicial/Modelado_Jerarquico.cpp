/*
Previo #5: Modelado Jerárquico en OpenGL: Creación de un Brazo Robótico	           |   Sánchez López Osvaldo
Fecha de entrega: 03 de marzo de 2026											   |   No. Cuenta: 318211396
*/
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Model Dedo2 A
		model = glm::translate(modelTemp2, glm::vec3(0.25f, 0.35f, -0.425f)); // Desfasado en Z para que quede al lado
